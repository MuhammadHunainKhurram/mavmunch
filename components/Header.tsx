        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center gap-3 group cursor-pointer">
            <div className="relative">
              <div className="w-12 h-12 bg-gradient-to-br from-uta-orange to-uta-orange-dark rounded-2xl flex items-center justify-center shadow-orange transform group-hover:rotate-6 transition-transform duration-300">
                <svg
                  viewBox="0 0 24 24"
              ...
              <div className="absolute -bottom-1 -left-1 w-3 h-3 bg-teal-400 rounded-full animate-pulse" style={{ animationDuration: '3s' }} />
            </div>
